...
urlpatterns = [
    ...
    path('fans/<int:fan_id>/', views.FanProfileDetail, name='fans_detail'),
    ...
    path('venues/<int:venue_id>/', views.VenueProfileDetail, name='venues_detail'),
    ...
    path('events/<int:event_id>/', views.EventDetail, name='events_detail'),
