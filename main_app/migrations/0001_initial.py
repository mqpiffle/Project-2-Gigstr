    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.IntegerField(choices=[(0, 'Admin'), (1, 'Fan'), (2, 'Band'), (3, 'Venue')], default=1, verbose_name='Role')),
        ...
        migrations.CreateModel(
            ...
            options={
                'permissions': (('access_band_dashboard', 'access band dashboard'),),
            },
        ),
        migrations.CreateModel(
            name='Event',
            fields=[
                ...
                ('bands', models.ManyToManyField(to='main_app.bandprofile')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fan', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main_app.fanprofile')),
            ],
        ),
        migrations.CreateModel(
            name='Heart',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('fan', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main_app.fanprofile')),
                ('target', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main_app.event')),
            ],
        ),
        migrations.AddField(
            model_name='event',
            name='venue',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main_app.venueprofile'),
        ),
        migrations.AddField(
